...
internal class LiteralToken(decimal value) : Token
{
...
internal class OperatorToken(Operator value, int numOperands, OperatorToken.Associativity operatorAssociativity) : Token
{
    ...
    public Associativity associativity => operatorAssociativity;
    ...
    public int Precedence => value switch
    {
        ...
        Operator.LPAREN => 5,
        Operator.RPAREN => 5,
        Operator.UNARY_PLUS => 4,
        Operator.UNARY_MINUS => 4,
        Operator.EXPONENT => 3,
        Operator.MULTIPLY => 2,
        Operator.DIVIDE => 2,
        Operator.PLUS => 1,
